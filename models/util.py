...
class SelfAttention(nn.Module):
    def __init__(self, feat_dim, s_n, s_w, t_n, n_cls, soft, factor=8): 
        ...
        #setattr(self, 'predict_teacher', MLPEmbed(t_w, self.n_cls))
        ...
        for i in range(self.s_len):
            setattr(self, 'predictor'+str(i), MLPEmbed(s_w[i], self.n_cls))
    ...
    def forward(self, f_s, f_t):
        ...
        pred_value_stu = []
        for i in range(self.s_len):
            pred_value_stu.append(getattr(self, 'predictor'+str(i))(f_s[i].view(f_s[i].shape[0],-1)))
        ...
        return proj_value_stu, value_tea, pred_value_stu, attention
